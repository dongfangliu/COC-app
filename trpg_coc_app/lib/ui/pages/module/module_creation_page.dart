...
class moduleCreationState extends State<moduleCreationPage> {
  ...
  Widget buildModuleHeader(BuildContext context) {
            ...
            child: Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      ...
                      image: buildCOCEditableImg(_moduleCreationBloc.getModule().thumbnailImg),
                      fit: BoxFit.fitWidth)),
              child: InkWell(
                onTap: () async {
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: buildCOCEditableImg(_moduleCreationBloc.getModule().iconImg),
                              fit: BoxFit.fitWidth)),
    ...
    void OnSubmmitBtnPressed(BuildContext context) {
      ...
      _moduleCreationBloc.getModule().hours_min = int.parse(hoursMinTextController.text);
      _moduleCreationBloc.getModule().hours_max = int.parse(hoursMaxTextController.text);
      _moduleCreationBloc.getModule().people_max = int.parse(peopleMaxTextController.text);
      _moduleCreationBloc.getModule().people_min = int.parse(peopleMinTextController.text);
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                MapCreationPage(_moduleCreationBloc.getModule().map),
                          ),
                        );
                      },
                    ),
            ...
            Padding(
                ...
                child: GridView(
                    ...
                    children: [
                      ...
                      Text("Support Map : "
//                    +
//                    (_moduleCreationBloc.getModule().map == null).toString()
                      ),
                      Text( "NPCS Num: "
//                    + _moduleCreationBloc.getModule().npcs.length.toString()
                      ),
                      Text("Scene Num : "
//                    + ((_moduleCreationBloc.getModule().map != null)? _moduleCreationBloc.getModule().map.scenes.length.toString():"0")
                      ),
